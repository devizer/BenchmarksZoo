...
sudo apt-get install -yq clang-format clang-tidy clang libc++-dev libc++1 libc++abi-dev libc++abi1 libclang-dev libclang1 libllvm-ocaml-dev libomp-dev libomp5 lld lldb llvm-dev llvm-runtime llvm
sudo apt-get install -yq clang-tools clangd liblldb-dev python-clang
